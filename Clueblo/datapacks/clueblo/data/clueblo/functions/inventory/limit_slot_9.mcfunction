...
execute if score @s hall_S matches 1 run replaceitem entity @s container.9 minecraft:clock{filler9b:1b,CustomModelData:1,display:{Name:'[{"translate":"clueblo.room.hall","color":"gold"}]'}} 1
execute if score @s hall_S matches 0 run replaceitem entity @s container.9 minecraft:clock{filler9b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.hall","color":"gold","strikethrough":"true"}]'}} 1
