...
execute if score @s music_S matches 1 run replaceitem entity @s container.13 minecraft:clock{filler13b:1b,CustomModelData:5,display:{Name:'[{"translate":"clueblo.room.music","color":"gold"}]'}} 1
execute if score @s music_S matches 0 run replaceitem entity @s container.13 minecraft:clock{filler13b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.music","color":"gold","strikethrough":"true"}]'}} 1
