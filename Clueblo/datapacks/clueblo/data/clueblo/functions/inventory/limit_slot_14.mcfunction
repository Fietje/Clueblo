...
execute if score @s winter_S matches 1 run item replace entity @s container.14 with minecraft:clock{filler14b:1b,CustomModelData:6,display:{Name:'[{"translate":"clueblo.room.winter","color":"gold"}]'}} 1
execute if score @s winter_S matches 0 run item replace entity @s container.14 with minecraft:clock{filler14b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.winter","color":"gold","strikethrough":"true"}]'}} 1
