...
execute if score @s chain_S matches 1 run item replace entity @s container.31 with minecraft:clock{filler31b:1b,CustomModelData:25,display:{Name:'[{"translate":"clueblo.weapon.chain","color":"#C4C4C4"}]'}} 1
execute if score @s chain_S matches 0 run item replace entity @s container.31 with minecraft:clock{filler31b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.weapon.chain","color":"#C4C4C4","strikethrough":"true"}]'}} 1
