...
execute if score @s eating_S matches 1 run item replace entity @s container.11 with minecraft:clock{filler11b:1b,CustomModelData:3,display:{Name:'[{"translate":"clueblo.room.dining","color":"gold"}]'}} 1
execute if score @s eating_S matches 0 run item replace entity @s container.11 with minecraft:clock{filler11b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.dining","color":"gold","strikethrough":"true"}]'}} 1
