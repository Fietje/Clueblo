...
execute if score @s dolch_S matches 1 run replaceitem entity @s container.27 minecraft:clock{filler27b:1b,CustomModelData:21,display:{Name:'[{"translate":"clueblo.weapon.sword","color":"#C4C4C4"}]'}} 1
execute if score @s dolch_S matches 0 run replaceitem entity @s container.27 minecraft:clock{filler27b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.weapon.sword","color":"#C4C4C4","strikethrough":"true"}]'}} 1
