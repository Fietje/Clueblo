...
replaceitem entity @s container.35 minecraft:clock{filler35b:1b,CustomModelData:51,display:{Name:'[{"translate":"clueblo.reset.button","color":"dark_aqua","italic":"false"}]'}} 1
