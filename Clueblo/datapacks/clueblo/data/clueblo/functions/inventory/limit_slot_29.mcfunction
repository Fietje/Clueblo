...
execute if score @s crossbow_S matches 1 run replaceitem entity @s container.29 minecraft:clock{filler29b:1b,CustomModelData:23,display:{Name:'[{"translate":"clueblo.weapon.crossbow","color":"#C4C4C4"}]'}} 1
execute if score @s crossbow_S matches 0 run replaceitem entity @s container.29 minecraft:clock{filler29b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.weapon.crossbow","color":"#C4C4C4","strikethrough":"true"}]'}} 1
