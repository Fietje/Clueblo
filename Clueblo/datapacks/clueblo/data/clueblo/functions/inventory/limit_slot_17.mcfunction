...
execute if score @s workroom_S matches 1 run item replace entity @s container.17 with minecraft:clock{filler17b:1b,CustomModelData:9,display:{Name:'[{"translate":"clueblo.room.work","color":"gold"}]'}} 1
execute if score @s workroom_S matches 0 run item replace entity @s container.17 with minecraft:clock{filler17b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.work","color":"gold","strikethrough":"true"}]'}} 1
