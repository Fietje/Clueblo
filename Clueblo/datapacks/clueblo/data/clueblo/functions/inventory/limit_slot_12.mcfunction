...
execute if score @s kitchen_S matches 1 run replaceitem entity @s container.12 minecraft:clock{filler12b:1b,CustomModelData:4,display:{Name:'[{"translate":"clueblo.room.kitchen","color":"gold"}]'}} 1
execute if score @s kitchen_S matches 0 run replaceitem entity @s container.12 minecraft:clock{filler12b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.kitchen","color":"gold","strikethrough":"true"}]'}} 1
