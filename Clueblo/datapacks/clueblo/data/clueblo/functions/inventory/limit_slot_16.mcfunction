...
execute if score @s bib_S matches 1 run item replace entity @s container.16 with minecraft:clock{filler16b:1b,CustomModelData:8,display:{Name:'[{"translate":"clueblo.room.library","color":"gold"}]'}} 1
execute if score @s bib_S matches 0 run item replace entity @s container.16 with minecraft:clock{filler16b:1b,CustomModelData:50,display:{Name:'[{"translate":"clueblo.room.library","color":"gold","strikethrough":"true"}]'}} 1
